			...
			case "kernel32.dll":
				try
				{
					...
					foreach (string function5 in array7)
					{
						...
						if (array12[0] == 144 || array12[0] == 233)
						{
							return true;
						}
					}
			...
			case "win32u.dll":
				try
				{
					...
					foreach (string function4 in array7)
					{
						...
						if (array11[0] == byte.MaxValue || array11[0] == 144 || array11[0] == 233)
						{
							return true;
						}
					}
			...
			case "user32.dll":
				try
				{
					...
					foreach (string function3 in array7)
					{
						...
						if (array10[0] == 144 || array10[0] == 233)
						{
							return true;
						}
					}
			...
			case "kernelbase.dll":
				try
				{
					...
					foreach (string function in array7)
					{
						...
						if (array8[0] == byte.MaxValue || array8[0] == 144 || array8[0] == 233)
						{
							return true;
						}
					}
